import { HighCard, TwoOfAKind, TwoPair, ThreeOfAKind, FourOfAKind, FullHouse, Straight, Flush, StraightFlush, RoyalFlush } from './hand';
...
export class HandEvaluator {
    ...
    public evaluate() {
        const hands = [
            ...
            new RoyalFlush(this.cards).evaluate()
        ].filter(hand => hand);
